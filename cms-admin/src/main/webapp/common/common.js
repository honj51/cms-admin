...
//判断是否是车牌
function isCarNoValid(value) {
	var re = /^[京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领]{1}[A-Z]{1}[A-Z0-9]{4}[A-Z0-9挂学警港澳]{1}$/;
...
//比较两个日期之间相差的时间大小 返回相差的秒数
function timeCompare(date1,date2){
    var oneDate = new Date(date1);
    var twoDate = new Date(date2);
