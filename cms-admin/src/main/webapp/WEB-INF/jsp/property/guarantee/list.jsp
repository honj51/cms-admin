...
<body>
	<form role="form" id="searchForm" name="searchForm">
		<div class="choice_condition_menu">
			...
			<input id="queryparam" class="selectpicker" placeholder="业主姓名"
				style="width: 150px;">
			<input id="userPhone" class="selectpicker" placeholder="业主电话"
				style="width: 150px;">
			<label class="control-label">审核结果</label> <select id="isManage"
	...
	<script src="${ctx}/js/property/guarantee/list.js<%=ts%>"></script>
</body>
</html>
