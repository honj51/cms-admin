...
<body>
	...
	<form id="form" name="form" class="form-horizontal">
		<div class="panel-body">
				...
				<div class="col-sm-9">
					<select class="selectpicker js-example-basic-single" name="transportationCompany" id="transportationCompany" style="width: 220px">
						...
						<c:forEach var="transportationCompanyFormMap" items="${transportationCompanyFormMaps}" varStatus="status">
							<option value="${transportationCompanyFormMap.id}">${transportationCompanyFormMap.name}</option>
						</c:forEach>
					</select>
				</div>
			</div>
			...
			<div class="form-group">
                ...
                type="text" class=form-control checkacc  value=""  
	...
	<script type="text/javascript" src="${ctx}/js/system/user/add.js<%=ts%>"></script>
</body>
</html>