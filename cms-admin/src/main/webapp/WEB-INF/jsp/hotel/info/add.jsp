...
<body style="overflow-x: hidden">
		...
		<div class="col-md-6">
			<form role="form" class="form-horizontal">
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input id="businessTime" type="text" class="form-control" placeholder="请输入营业时间"/>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<textarea row="2" type="text" class="form-control" id="info"></textarea>
					</div>
				</div>
				<div class="form-group">
	...
	<script src="${ctx}/js/hotel/info/add.js<%=ts%>"></script>
</body>
</html>