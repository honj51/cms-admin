...
<body>
	<form role="form" id="searchForm" name="searchForm" style="position:relative">
		<div class="choice_condition_menu">
			<input id="queryparam" class="selectpicker" placeholder="顾客姓名/顾客电话"
				style="width: 150px;">
				<input id="reserveStartTime" class="selectpicker"
					placeholder="预定开始时间" style="width: 150px;">
			-
				<input id="reserveEndTime" class="selectpicker" placeholder="预定结束时间"
					style="width: 150px;">
			<label class="control-label">包厢类型</label> <select id="boxType"
				class="selectpicker" data-width="100px">
				<option value="">全部</option>
				<option value="1">大厅</option>
				<option value="2">包间</option>
			</select> <label class="control-label">是否处理</label> <select id="isManage"
				class="selectpicker" data-width="100px">
				<option value="">全部</option>
	...
	<script src="${ctx}/js/hotel/reserve/list.js<%=ts%>"></script>
</body>
</html>
