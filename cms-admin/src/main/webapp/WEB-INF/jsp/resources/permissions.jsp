...
<script type="text/javascript">
	...
	function sub() {
		ly.ajax({
			...
			url : rootPath + '/shipper/resources/addUserRes.shtml',
			dataType : 'json',
...
<body>
	...
	<script type="text/javascript">
		...
		$.ajax({
			type : "POST",
			data : {
				"shipperResFormMap.userId" : "${param.userId}",
				"shipperResFormMap.roleId" : "${param.roleId}"
			},
			url : rootPath + '/shipper/resources/findRes.shtml',
			dataType : 'json',
			success : function(json) {
				for (index in json) {
					$(
